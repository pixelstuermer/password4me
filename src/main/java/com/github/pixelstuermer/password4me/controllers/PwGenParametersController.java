...
public class PwGenParametersController {
   ...
   @RequestMapping( method = RequestMethod.GET, value = "/headerParams" )
   @ApiOperation( value = "Returns a parameterized password according to HTTP headers" )
   public ResponseEntity<PasswordMap> generatePwWithHttpHeaderParams(
   ...
   @RequestMapping( method = RequestMethod.GET, value = "/urlParams" )
   @ApiOperation( value = "Returns a parameterized password according to URL parameters" )
   public ResponseEntity<PasswordMap> generatePwWithUrlHeaderParams(
      @RequestParam( value = "smallChars", required = true ) boolean smallChars,
      @RequestParam( value = "capsChars", required = true ) boolean capsChars,
      @RequestParam( value = "numberChars", required = true ) boolean numberChars,
      @RequestParam( value = "specialChars", required = true ) boolean specialChars,
